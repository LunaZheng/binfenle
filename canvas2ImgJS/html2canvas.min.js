...
(function(a, b, c, d, e, f) {
  ...
  C.prototype.getMetrics = function(a, b) {
    ...
    return "SELECT" === this.node.tagName ? a = K(this.node) : "password" === this.node.type && (a = Array(a.length + 1).join("鈥�")), 0 === a.length ? this.node.placeholder || "" : a
    ...
    var b = a.parseBounds(),
      ...
      h = Y(d, f, g);
    this.renderer.clip(a.backgroundClip, function() {
      this.renderer.rectangle(d.left + 1, d.top + 1, d.width - 2, d.height - 2, new z("#DEDEDE")), this.renderer.renderBorders(W(g, d, h, f)), a.node.checked && (this.renderer.font(new z("#424242"), "normal", "normal", "bold", c - 3 + "px", "arial"), this.renderer.text("鉁�", d.left + c / 6, d.top + c - 1))
    }, this)
