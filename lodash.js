...
(function(n) {
  function t(o) {
    function f(n) {
      ...
      var t = n.valueOf,
        e = typeof t == "function" && (e = Zt(t)) && Zt(e);
    ...
    function P(n, t, e) {
      ...
      for (var o = arguments, i = 0, f = typeof e == "number" ? 2 : o.length; ++i < f;)
        if ((u = o[i]) && R[typeof u]) {
          var c = u.length;
          if (r = -1, me(u))
            for (; ++r < c;) "undefined" == typeof a[r] && (a[r] = u[r]);
          else
            for (var l = -1, p = R[typeof u] ? be(u) : [], c = p.length; ++l < c;) r = p[l], "undefined" == typeof a[r] && (a[r] = u[r])
        }
      return a
    }
    ...
    function K(n, t, e) {
      ...
      else 2 < f && "function" == typeof o[f - 1] && (c = o[--f]);
      for (; ++i < f;)
        if ((u = o[i]) && R[typeof u]) {
          var l = u.length;
          if (r = -1, me(u))
            for (; ++r < l;) a[r] = c ? c(a[r], u[r]) : u[r];
          else
            for (var p = -1, s = R[typeof u] ? be(u) : [], l = s.length; ++p < l;) r = s[p], a[r] = c ? c(a[r], u[r]) : u[r]
        }
      return a
    }
    ...
    function ut(n, t, e, o, i, f) {
      ...
      for (i || (i = []), f || (f = []), v = i.length; v--;)
        if (i[v] == n) return f[v] == t;
      var y = 0,
        p = r;
      if (i.push(n), f.push(t), s) {
        ...
        for (; y--;)
          if (s = v, g = t[y], c)
            for (; s-- && !(p = ut(n[s], g, e, o, i, f)););
          else if (!(p = ut(n[y], g, e, o, i, f))) break;
        return p
      }
    ...
    function ct(n, t, e) {
      ...
      if (e === l) var o = r[3],
        i = r[4],
        c = r[5];
      else i = [], c = [], typeof e != "number" && (a = r.length), 3 < a && "function" == typeof r[a - 2] ? o = U.createCallback(r[--a - 1], r[a--], 2) : 2 < a && "function" == typeof r[a - 1] && (o = r[--a]);
    ...
    function yt(n, t, e) {
      var r = -1,
        u = n ? n.length : 0;
      if (t = t && typeof e == "undefined" ? t : U.createCallback(t, e), typeof u == "number")
        for (; ++r < u && t(n[r], r, n) !== a;);
      else D(n, t);
      return n
    }
    ...
    function ht(n, t, e) {
      var r = -1,
        u = n ? n.length : 0;
      if (t = U.createCallback(t, e), typeof u == "number")
        for (var a = Rt(u); ++r < u;) a[r] = t(n[r], r, n);
    ...
    function xt(n, t, e) {
      var r = -1,
        u = n ? n.length : 0;
      if (typeof e == "number") r = (0 > e ? le(0, u + e) : e || 0) - 1;
      else if (e) return r = Et(n, t), n[r] === t ? r : -1;
      for (; ++r < u;)
        if (n[r] === t) return r;
      return -1
    }
    ...
    var Rt = o.Array,
      ...
      Ht = Kt(),
      Jt = o._,
      Lt = Mt("^" + Ut(Ht.valueOf).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"),
      Qt = zt.ceil,
      Wt = o.clearTimeout,
      Xt = Gt.concat,
      Yt = zt.floor,
      Zt = Lt.test(Zt = Kt.getPrototypeOf) && Zt,
      ne = Ht.hasOwnProperty,
      te = Gt.push,
      ee = o.setImmediate,
      re = o.setTimeout,
      ue = Ht.toString,
      ae = Lt.test(ae = ue.bind) && ae,
      oe = Lt.test(oe = Rt.isArray) && oe,
      ie = o.isFinite,
      fe = o.isNaN,
      ce = Lt.test(ce = Kt.keys) && ce,
      le = zt.max,
      pe = zt.min,
      se = o.parseInt,
      ve = zt.random,
      ge = Gt.slice,
      zt = Lt.test(o.attachEvent),
      zt = ae && !/\n|true/.test(ae + zt),
      ye = {};
    ye[E] = Rt, ye[I] = Tt, ye[N] = qt, ye[A] = Kt, ye[S] = Pt, ye[$] = Mt, ye[B] = Ut;
    var he = U.support = {};
    he.fastBind = ae && !zt, U.templateSettings = {
      escape: /<%-([\s\S]+?)%>/g,
      evaluate: /<%([\s\S]+?)%>/g,
      interpolate: d,
      variable: "",
    ...
    return zt && i && typeof ee == "function" && (At = St(ee, o)), Tt = 8 == se(_ + "08") ? se : function(n, t) {
      ...
      if (e === r) var v = r,
        s = a;
      else e && R[typeof e] && (v = e.leading, s = "trailing" in e ? e.trailing : s);
      return function() {
      ...
      n: for (; ++u < a;) {
        var c = n[u];
        if (o) var l = p + c,
          l = r[0][l] ? !(f = r[0][l]) : f = r[0][l] = [];
        if (l || 0 > xt(f, c)) {
          o && f.push(c);
          for (var v = e; --v;)
            if (!(r[v] || (r[v] = V(t[v])))(c)) continue n;
          i.push(c)
        }
      }
      return i
    }, U.invert = rt, U.invoke = function(n, t) {
      var e = ge.call(arguments, 2),
        r = -1,
        u = typeof t == "function",
        a = n ? n.length : 0,
        o = Rt(typeof a == "number" ? a : 0);
      ...
      var r = typeof t == "function",
        u = {};
      if (r) t = U.createCallback(t, e);
      else var a = Xt.apply(Gt, ge.call(arguments, 1));
      ...
      if (typeof t != "function")
        for (var u = -1, a = Xt.apply(Gt, ge.call(arguments, 1)), o = ot(n) ? a.length : 0; ++u < o;) {
          var i = a[u];
          i in n && (r[i] = n[i])
      ...
      var i, f, c, l, p = 0,
        s = r,
        v = r;
      return e === a ? s = a : e && R[typeof e] && (s = "leading" in e ? e.leading : s, v = "trailing" in e ? e.trailing : v),
        function() {
          var e = new qt;
          !l && !s && (p = e);
          var r = t - (e - p);
      ...
      for (var t = -1, e = n ? n.length : 0, r = e ? mt(bt(n, "length")) : 0, u = Rt(r); ++t < e;)
        for (var a = -1, o = n[t]; ++a < r;)(u[a] || (u[a] = Rt(e)))[t] = o[a];
      return u
      ...
      var r = -1,
        u = n ? n.length : 0;
      for (t = U.createCallback(t, e); ++r < u;)
      ...
      var r = n ? n.length : 0;
      for (typeof e == "number" && (r = (0 > e ? le(0, r + e) : pe(e, r - 1)) + 1); r--;)
        if (n[r] === t) return r;
      return -1
      ...
      n || (n = ""), u = P({}, u, a);
      var o, i = P({}, u.imports, a.imports),
        a = be(i),
        i = lt(i),
        f = 0,
        c = u.interpolate || w,
        l = "__p+='",
        c = Mt((u.escape || w).source + "|" + c.source + "|" + (c === d ? m : w).source + "|" + (u.evaluate || w).source + "|$", "g");
  ...
  var e, r = !0,
    u = null,
    a = !1,
    o = typeof exports == "object" && exports,
    i = typeof module == "object" && module && module.exports == o && module,
    f = typeof global == "object" && global;
  ...
  var c = 0,
    ...
    j = /[&<>"']/g,
    C = /['\n\r\t\u2028\u2029\\]/g,
    x = "Array Boolean Date Function Math Number Object RegExp String _ attachEvent clearTimeout isFinite isNaN parseInt setImmediate setTimeout".split(" "),
    O = "[object Arguments]",
    E = "[object Array]",
    I = "[object Boolean]",
    N = "[object Date]",
